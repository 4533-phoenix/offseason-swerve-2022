package frc.robot.sdsLib.rev;

import com.revrobotics.CANSparkMax;
import com.revrobotics.CANSparkMaxLowLevel;
import com.revrobotics.RelativeEncoder;

import frc.robot.sdsLib.DriveController;
import frc.robot.sdsLib.DriveControllerFactory;
import frc.robot.sdsLib.ModuleConfiguration;

import static frc.robot.sdsLib.rev.RevUtils.checkNeoError;

public final class NeoDriveControllerFactoryBuilder {
    private double nominalVoltage = Double.NaN;
    private double currentLimit = 30.0;
